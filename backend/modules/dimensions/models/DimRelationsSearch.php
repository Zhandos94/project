...
/**
 * DimRelationsSearch represents the model behind the search form about `backend\modules\dimensions\models\DimRelations`.
 */
class DimRelationsSearch extends DimRelations
{
    /**
     * @inheritdoc
     */
