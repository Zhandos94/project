...
<div class="auth-item-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            [
                'attribute' => 'name',
                'contentOptions' => ['class' => 'parent_name'],
            ],
            'description:text',
            'rule_name',
            'created_at:date',
...
<div class="row">
    <div class="col-sm-5 block_left">
        ...
        <select id='select_left' multiple size="15" class="form-control list" data-target="avaliable">
            ...
            <?php foreach ($leftArray as $key => $values) { ?>
    ...
    <div class="col-sm-5 block_right">
        ...
        <select id='select_right' multiple size="15" class="form-control list" data-target="assigned">

            <?php foreach ($rightArray as $key => $values) { ?>
